...
class MapScreen extends StatefulWidget {
  String orderId;
  MapScreen({super.key, required this.orderId});
  @override
...
class _MapScreenState extends State<MapScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await loc.fetchCurrentLocation(widget.orderId);
            ...
            Positioned.fill(
              child: gmaps.GoogleMap(
                initialCameraPosition: gmaps.CameraPosition(
                  target: _userLatLng ?? _defaultLatLng,
                  zoom: 16,
                ),
                onMapCreated: (controller) {
                  ...
                  if (_userLatLng != null) {
                    controller.animateCamera(
                      gmaps.CameraUpdate.newLatLngZoom(_userLatLng!, 16),
                    );
                  }
                },
                markers: {
                ...
                onTap: (latLng) async {
                  ...
                  await context.read<SourceLocationProvider>().fetchCurrentLocation(
                    widget.orderId,
                  );
